...
const Layout = ({ children }) => {
    return (
        <div className="flex h-screen bg-gray-100 md:bg-gray-200 overflow-hidden font-sans">
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `flex items-center space-x-4 px-4 py-3 rounded-xl transition-colors ${
                                        isActive
                                        ? 'bg-blue-100 text-blue-600 border-2 border-blue-200 font-bold'
                                        : 'text-gray-600 hover:bg-gray-100 hover:text-gray-800 font-semibold border-2 border-transparent'
                                    }`
                                }
                            >
                                {item.icon}
            ...
            <main className="flex-1 h-full overflow-y-auto w-full flex justify-center pb-24 md:pb-0">
                <div className="w-full bg-white min-h-full border-x-0 md:border-x-2 border-gray-200 shadow-sm relative">
                    {children}
                </div>
            </main>
                    ...
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex flex-col items-center justify-center p-2 rounded-xl transition-colors ${
                                isActive ? 'text-blue-600 bg-blue-100 border-2 border-blue-200' : 'text-gray-500 border-2 border-transparent'
                            }`
                        }
                    >
                        {item.icon}
